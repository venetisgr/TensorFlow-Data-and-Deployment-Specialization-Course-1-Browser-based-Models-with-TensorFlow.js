...
function draw(e) {  //responsible for drawing
    ...
    ctx.stroke();
    rawImage.src = canvas.toDataURL('image/png'); //drawn image is stored here
}
    
function erase() { //clears the drawn image
    ctx.fillStyle = "black";
    ctx.fillRect(0,0,280,280);
}
    
function save() { //classify button functionality
